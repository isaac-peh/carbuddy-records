      ...
      <DialogContent className="w-[calc(100%-2rem)] max-w-7xl h-[85vh] flex flex-col gap-0 p-0 overflow-hidden">
        ...
        <div className="px-4 sm:px-6 pt-6 pb-4 border-b border-border/60 shrink-0 sm:pr-12">
          <div className="flex flex-col sm:flex-row sm:items-start justify-between gap-3">
            ...
            <div className="flex items-center w-full sm:w-auto sm:mx-0 bg-secondary/50 rounded-lg border border-border/40 shrink-0">
              ...
              <div className="lg:col-span-4 space-y-5">
                ...
                <Card>
                  ...
                  <CardContent className="pt-0">
                    ...
                    {isLowStock && (
                      <>
                        <div className="flex items-center gap-2 bg-destructive/10 border border-destructive/20 rounded-lg px-3 py-2.5 mb-3">
                        ...
                        <Button
                          variant="outline"
                          size="sm"
                          className="w-full h-8 text-xs gap-1.5 mb-4"
